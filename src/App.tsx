          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight">
                {t.heroTitle.split(' ')[0]} <span className="text-[#24b49a]">{t.heroTitle.split(' ').slice(1).join(' ')}</span>
              </h1>
            ...
            <div className="relative flex flex-col items-center lg:items-end">
              <div className="relative w-full max-w-lg mb-4">
                <div className="rounded-[28px] bg-gradient-to-br from-white via-slate-50 to-white shadow-[0_30px_80px_-40px_rgba(0,0,0,0.35)] p-3">
                  <img 
